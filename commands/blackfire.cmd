...
MAGEFLEET_ENV_BLACKFIRE_COMMAND=${MAGEFLEET_ENV_BLACKFIRE_COMMAND:-blackfire}
MAGEFLEET_ENV_BLACKFIRE_CONTAINER=${MAGEFLEET_ENV_BLACKFIRE_CONTAINER:-php-blackfire}

## allow return codes from sub-process to bubble up normally
trap '' ERR

"$MAGEFLEET_BIN" env exec "${MAGEFLEET_ENV_BLACKFIRE_CONTAINER}" \
    "${MAGEFLEET_ENV_BLACKFIRE_COMMAND}" "${MAGEFLEET_PARAMS[@]}" "$@"
