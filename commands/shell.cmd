...
MAGEFLEET_ENV_SHELL_COMMAND=${MAGEFLEET_ENV_SHELL_COMMAND:-bash}
MAGEFLEET_ENV_SHELL_CONTAINER=${MAGEFLEET_ENV_SHELL_CONTAINER:-php-fpm}

## allow return codes from sub-process to bubble up normally
trap '' ERR

"$MAGEFLEET_BIN" env exec "${MAGEFLEET_ENV_SHELL_CONTAINER}" \
    "${MAGEFLEET_ENV_SHELL_COMMAND}" "${MAGEFLEET_PARAMS[@]}" "$@"
